...
```javascript
import FLOAT32_SQRT3 from 'https://cdn.jsdelivr.net/gh/stdlib-js/constants-float32-sqrt-three@v0.1.1-esm/index.mjs';
```
...
[test-image]: https://github.com/stdlib-js/constants-float32-sqrt-three/actions/workflows/test.yml/badge.svg?branch=v0.1.1
[test-url]: https://github.com/stdlib-js/constants-float32-sqrt-three/actions/workflows/test.yml?query=branch:v0.1.1
